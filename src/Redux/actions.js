...
export const deletePokeBd = async(id)=>{
    try {
        const response = await axios.delete(`https://api-nine-eosin.vercel.app/pokemons/deletepoke/${id}`)
        return(response)
    } catch (error) {
...
export const getAllPokemos = () => {
    return function(dispatch) {
        fetch("https://api-nine-eosin.vercel.app/pokemons")
...
export const getAllTypes =()=>{
    return function(dispatch) {
        fetch("https://api-nine-eosin.vercel.app/pokemons/tipos")
        .then(result => result.json())
        .then(data => {
    ...
    export const postPokeArray = async (postArray)=>{
        ...
        try {
            const response = await axios.post("https://api-nine-eosin.vercel.app/pokemons",data);
            return (response)
        } catch (error) {
            return (error);
        }
